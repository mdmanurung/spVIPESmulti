...
def minimal_two_group_adata():
    ...
    adata_full.obs["cell_type"] = ["type_A"] * 100 + ["type_B"] * 100
    adata_full.obs["sample"] = ["sample_1"] * 50 + ["sample_2"] * 50 + ["sample_3"] * 50 + ["sample_4"] * 50
...
class TestOrthogonalityHelperUnit:
    ...
    def test_orthogonality_zero_for_independent_inputs(self):
        ...
        corr_norm_mean, corr_norm_worst, _ = _within_stratum_corr_norm(z_shared, z_private, strata_ids, min_cells=10)
